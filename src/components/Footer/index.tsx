    ...
    return (
        <div className="flex bg-headerColor px-16 py-8 text-white">
            ...
            <ul className="flex flex-col items-start gap-4 pl-16">
                <li className="flex items-center gap-2 h-[35px] text-[#15bef7]">
                    <svg
                        width="100%"
                        height="100%"
                        ...
                        className="flex self-center text-sm origin-center"
                    >
                ...
                <li className="flex items-center gap-2">
                    <BiLogoTypescript className="text-[#3178c6] text-4xl" />
                    <p className="font-semibold text-white">Typescript</p>
                </li>

                <li className="flex items-center gap-2">
                    <svg viewBox="0 0 167 21" fill="none" className="h-5">
                        <path
